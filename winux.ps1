...
$toAutomaticServices = @( "ETDService", "UevAgentService", "vds", "vmcompute", "vmicguestinterface", "vmicheartbeat", "vmickvpexchange", "vmicrdv", "vmicshutdown", "vmictimesync", "vmicvmsession", "vmicvss", "vmms", "PrintNotify", "Spooler", "NVDisplay.ContainerLocalSystem", "Dhcp", "Dnscache", "WlanSvc", "AtherosSvc" , "MpsSvc" )
...
Write-Host "`n`nList of things to configure via GUI or more powershell knowledge:
         ---------------------------------------------------
♥ Equipo > Propiedades del SSD > General: Indizado = 0
♥ Equipo > Propiedades del SSD > Herramientas: Optimizar = 0
